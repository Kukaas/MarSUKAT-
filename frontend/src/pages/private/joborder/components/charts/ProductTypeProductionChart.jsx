...
export function ProductTypeProductionChart({ data, loading }) {
    ...
    return (
      <Card className="border-border/40 bg-card/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 hover:shadow-lg transition-shadow">
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
          <CardTitle className="text-sm font-medium">Production by Product Type</CardTitle>
  ...
  if (!data || !data.productTypeBreakdown || data.productTypeBreakdown.length === 0) {
    return (
      <Card className="border-border/40 bg-card/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 hover:shadow-lg transition-shadow">
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
          <CardTitle className="text-sm font-medium">Production by Product Type</CardTitle>
        ...
        <CardContent>
          <EmptyState
            icon={Shirt}
            message="No product type production data available"
          />
        </CardContent>
      </Card>
    );
