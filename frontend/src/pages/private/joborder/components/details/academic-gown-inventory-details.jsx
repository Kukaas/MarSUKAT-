...
function AcademicGownInventoryContent({ item }) {
  const statusMessages = {
    "Low Stock": "This academic gown is running low. Consider restocking soon.",
    "Out of Stock":
      "This academic gown is currently out of stock and needs to be replenished.",
  };
  ...
  return (
    <ScrollArea className="h-full">
      <div className="space-y-6 sm:space-y-8">
        ...
        {item?.image?.data && (
          <div className="space-y-4 sm:space-y-6">
            <SectionTitle>Academic Gown Image</SectionTitle>
...
const AcademicGownInventoryDetailsDialog = ({ isOpen, onClose, item }) => {
  if (!item) return null;
  ...
  return (
    <ViewDetailsDialog
      open={isOpen}
      onClose={onClose}
      title="Academic Gown Item Details"
    >
      <AcademicGownInventoryContent item={item} />
    </ViewDetailsDialog>
  );
};

export { AcademicGownInventoryDetailsDialog, AcademicGownInventoryContent }; 