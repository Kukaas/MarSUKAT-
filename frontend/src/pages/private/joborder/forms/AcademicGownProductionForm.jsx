...
export function AcademicGownProductionForm({
  formData,
  setFormData,
  isEdit = false,
  onSubmit,
        ...
        <div className="space-y-8">
          ...
          <div className="grid gap-6 sm:grid-cols-2">
            ...
            <FormSelect
              ...
              name="productType"
              label="Product Type"
              placeholder="Select a gown type"
          ...
          <div className="space-y-4">
            ...
            {selectedProductType ? (
              selectedProductType.rawMaterialsUsed.length > 0 ? (
                ...
                <EmptyState 
                  message="No raw materials have been specified for this gown type."
                />
              )
            ) : (
              <EmptyState 
                message="Select a level, gown type, and size to view required raw materials."
              />
            )}
          </div>
        </div>
