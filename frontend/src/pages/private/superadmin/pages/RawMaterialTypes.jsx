  ...
  return (
    <PrivateLayout>
      <div className="space-y-6">
        <SectionHeader
          title="Raw Material Type Management"
          description="Manage raw material types in the system"
        />
        ...
        <DataTable
          ...
          createButtonText={
            <div className="flex items-center gap-2">
              ...
              <span>Create Raw Material Type</span>
            </div>
          }
        />
          ...
          <AlertDialogContent className="sm:max-w-[600px]">
            <AlertDialogHeader>
              ...
              <AlertDialogDescription className="text-gray-500">
                Add a new raw material type to the system
              </AlertDialogDescription>
            </AlertDialogHeader>
            <div className="py-2">
              <RawMaterialTypeForm
        ...
        <AlertDialog open={isEditDialogOpen}>
          <AlertDialogContent className="sm:max-w-[600px]">
            <AlertDialogHeader>
              ...
              <AlertDialogDescription className="text-gray-500">
                Modify the raw material type details
              </AlertDialogDescription>
            </AlertDialogHeader>
            <div className="py-2">
              <RawMaterialTypeForm
