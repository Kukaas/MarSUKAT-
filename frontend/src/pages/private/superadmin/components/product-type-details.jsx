...
function ProductTypeContent({ productType }) {
  return (
    <ScrollArea className="h-full">
      <div className="space-y-6 sm:space-y-8 px-6">
        {/* Header with Product Type Info */}
        <div className="relative">
          ...
          <div className="relative pt-6 sm:pt-8 px-4 flex flex-col items-center space-y-3 sm:space-y-4">
            ...
            <div className="text-center pb-3 sm:pb-4">
              ...
              <StatusBadge
                status={productType?.productTypeId || "Unknown"}
                icon={Info}
        ...
        <div className="space-y-4 sm:space-y-6">
          ...
          <div className="grid gap-3 sm:gap-4 grid-cols-1 sm:grid-cols-2">
            ...
            <InfoCard
              ...
              label="Updated At"
              value={
                formatDate(productType?.updatedAt, "long") || "Not updated yet"
              }
            />
          </div>
        </div>
...
const ProductTypeDetailsDialog = ({ isOpen, onClose, productType }) => {
  ...
  return (
    ...
    >
      <ProductTypeContent productType={productType} />
    </ViewDetailsDialog>
  );
};

// Add ProductTypeDetails export for backward compatibility
const ProductTypeDetails = ({ productType }) => (
  <ProductTypeContent productType={productType} />
);

export { ProductTypeDetailsDialog, ProductTypeDetails };
