...
function DepartmentContent({ department }) {
  return (
        ...
        <div className="relative">
          ...
          <div className="relative pt-6 sm:pt-8 px-4 flex flex-col items-center space-y-3 sm:space-y-4">
            ...
            <div className="text-center pb-3 sm:pb-4">
              ...
              <StatusBadge
                status={department?.departmentId || "Unknown"}
                icon={Info}
        ...
        <div className="space-y-4 sm:space-y-6">
          ...
          <div className="grid gap-3 sm:gap-4 grid-cols-1 sm:grid-cols-2">
            ...
            <InfoCard
              icon={Calendar}
              label="Updated At"
              value={formatDate(department?.updatedAt, "long") || "Not updated yet"}
            />
          </div>
        </div>
...
const DepartmentDetailsDialog = ({ isOpen, onClose, department }) => {
  if (!department) return null;

  return (
    <ViewDetailsDialog open={isOpen} onClose={onClose} title="Department Details">
      <DepartmentContent department={department} />
    </ViewDetailsDialog>
  );
};

// Add DepartmentDetails export for backward compatibility
const DepartmentDetails = ({ department }) => (
  <DepartmentContent department={department} />
);

export { DepartmentDetailsDialog, DepartmentDetails };
