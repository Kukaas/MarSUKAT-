        ...
        <div className="relative">
          ...
          <div className="relative pt-6 sm:pt-8 px-4 flex flex-col items-center space-y-3 sm:space-y-4">
            ...
            <div className="text-center pb-3 sm:pb-4">
              ...
              <StatusBadge
                status={category?.categoryId || "Unknown"}
                icon={Info}
        ...
        <div className="space-y-4 sm:space-y-6">
          ...
          <div className="grid gap-3 sm:gap-4 grid-cols-1 sm:grid-cols-2">
            ...
            <InfoCard
              ...
              label="Updated At"
              value={
                formatDate(category?.updatedAt, "long") || "Not updated yet"
              }
            />
          </div>
        </div>
...
const CategoryDetailsDialog = ({ isOpen, onClose, category }) => {
  if (!category) return null;

  return (
    <ViewDetailsDialog open={isOpen} onClose={onClose} title="Category Details">
      <CategoryContent category={category} />
    </ViewDetailsDialog>
  );
};

// Add CategoryDetails export for backward compatibility
const CategoryDetails = ({ category }) => (
  <CategoryContent category={category} />
);

export { CategoryDetailsDialog, CategoryDetails };
