...
const NotificationItem = ({ notification }) => {
  ...
  return (
    <div className="flex flex-col gap-2 p-3 md:p-4 rounded-lg border bg-card hover:bg-accent transition-colors opacity-80">
      {/* Header */}
      ...
      <div className="pl-10">
        ...
        {hasLongMessage && (
          <Button
            ...
            className="h-7 px-2 mt-2 text-[10px] text-muted-foreground hover:text-foreground flex items-center gap-1 md:hidden"
          >
...
const ReadNotifications = ({ notifications = [], loading }) => {
